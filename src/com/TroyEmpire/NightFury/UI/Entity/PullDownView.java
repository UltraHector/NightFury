...
import com.TroyEmpire.NightFury.UI.Entity.ScrollOverListView.OnScrollOverListener;
...
public class PullDownView extends LinearLayout implements OnScrollOverListener{
	...
	private void initHeaderViewAndFooterViewAndListView(Context context){
		 ...
		 * 如果要修改，和它相关的设置都要更改
		 */
		mHeaderView = LayoutInflater.from(context).inflate(R.layout.xinxipt_pulldown_header, null);
		 ...
		 * 自定义脚部文件
		 */
		mFooterView = LayoutInflater.from(context).inflate(R.layout.xinxipt_pulldown_footer, null);
